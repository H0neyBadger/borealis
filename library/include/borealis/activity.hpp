...
#define CONTENT_FROM_XML_RES(x) brls::View* createContentView() override {return brls::View::createFromXMLResource(x);}
#define CONTENT_FROM_XML_FILE(x) brls::View* createContentView() override {return brls::View::createFromXMLFile(x);}
#define CONTENT_FROM_XML_STR(x) brls::View* createContentView() override {return brls::View::createFromXMLString(x);}
